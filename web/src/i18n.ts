...
const fr = {
  ...
  my: {
    ...
    export: {
      ...
      countLabel: "Articles : {count}",
      heroPriorityOne: "Priorité 1 : {count}",
      heroReminder: "Commence par ces indispensables",
      linkLabel: "Lien",
      priceLabel: "Prix",
      ...
      none: "Non renseigné",
      priorityOneTitle: "À traiter en priorité 1",
      priorityOneSubtitle: "Les coups de cœur à acheter en premier",
      otherTitle: "Autres idées cadeaux",
      otherSubtitle: "Le reste de la liste, trié par priorité",
      priorityOneHint: "Mettre en haut du panier",
      standardHint: "Idée classée par priorité",
    },
    form: {
      title: "Titre",
      url: "Lien (optionnel)",
