...
const fr = {
  ...
  my: {
    ...
    publish: {
      badge: "Lettre au Père Noël",
      title: "Publier ta lettre",
      description:
        "Génère une jolie page à partager, accessible même sans compte.",
      hint: "Tu pourras la retirer à tout moment.",
      empty: "Ajoute au moins un article avant de publier.",
      action: "Publier ma lettre",
      copy: "Copier le lien",
      preview: "Voir la page",
      unpublish: "Retirer le lien",
      unpublishConfirm: "Désactiver le lien public ?",
      published: "Lien prêt à être partagé !",
      unpublished: "Lien désactivé.",
      copied: "Lien copié",
      online: "En ligne",
  ...
  public: {
    ...
    subtitle: "Une lettre à partager sans se connecter.",
    ...
    signature: "Avec amour, {name}",
    footer: "Que la magie de Noël t’accompagne ✨",
    someone: "un·e proche",
